...
export default function ContactPage() {
  return <StaticInfoPage eyebrow="Contact" title="Start a conversation." description="For collaborations, production inquiries, licensing, editorial questions, or studio partnerships, contact FourFeetz Studios by email." sections={[
    { title: "Studio Inquiries", paragraphs: ["Email hello@fourfeetz.com with a short introduction, the nature of your inquiry, and any relevant timeline or project links. We review messages carefully and reply when there is a clear fit."] },
  ...
  ]} cta={{ eyebrow: "Email", title: "hello@fourfeetz.com", description: "The simplest way to reach the studio for thoughtful, project-specific inquiries.", href: "mailto:hello@fourfeetz.com", label: "Send Email" }} />;
}
