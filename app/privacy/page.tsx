...
export default function PrivacyPage() {
  return <StaticInfoPage eyebrow="Policy" title="Privacy Policy" description="This policy explains how FourFeetz Studios handles information when you visit the website or contact the studio." updated="July 15, 2026" sections={[
    ...
    { title: "Google Advertising", paragraphs: ["FourFeetz may display advertisements provided by Google AdSense.", "Google and its partners may use cookies to serve personalized or non-personalized advertisements based on previous visits to this or other websites.", <>Visitors can opt out of personalized advertising by visiting Google Ads Settings: <a href="https://adssettings.google.com/" className="font-bold text-[#6f4e37] underline underline-offset-4">https://adssettings.google.com/</a></>, "Visitors can learn more about how Google uses information by visiting Google's advertising and privacy policies."] },
