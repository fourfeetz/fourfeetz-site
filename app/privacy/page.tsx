...
export default function PrivacyPage() {
  return <StaticInfoPage eyebrow="Policy" title="Privacy Policy" description="This policy explains how FourFeetz Studios handles information when you visit the website or contact the studio." updated="July 13, 2026" sections={[
    ...
    { title: "Retention & Your Choices", paragraphs: ["We retain personal information only as long as reasonably necessary for the purpose it was collected, legal obligations, or dispute resolution. You may request access, correction, or deletion by contacting hello@fourfeetz.com, subject to applicable law."] },
