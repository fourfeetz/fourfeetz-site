...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://fourfeetz.com/insights" },
  openGraph: { title: "Insights | FourFeetz Studios", description: "A professional creator knowledge hub built from real FourFeetz and HARU production experience.", url: "https://fourfeetz.com/insights", images: ["/images/insights-hero-v2.png"] },
