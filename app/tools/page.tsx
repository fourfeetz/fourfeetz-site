...
const title = "Tools in FourFeetz Production | FourFeetz";
const description = "See the documented role, practical limit, and related FourFeetz production record for each AI video, music, planning, and editing tool used by the studio.";
...
const tools: Tool[] = [
  {
    ...
    sponsored: true,
    evidence: { href: "/insights/turning-short-scene-into-relaxing-video", label: "HARU relaxing-video production record" },
  },
  {
    name: "Runway",
    mark: "RW",
    ...
    button: "Visit Runway",
    sponsored: false,
    evidence: { href: "/insights/how-haru-was-created", label: "HARU character production record" },
  ...
  },
  {
    ...
    button: "Learn More",
    sponsored: false,
    evidence: { href: "/insights/what-we-keep-private-character-production", label: "FourFeetz production-sharing policy" },
  },
  {
    name: "Suno",
    mark: "SU",
    ...
    button: "Learn More",
    sponsored: false,
    evidence: { href: "/insights/calming-dog-music-puppy-kitten-fireplace-rain", label: "Relax Moments music production record" },
  },
  {
    name: "CapCut",
    mark: "CC",
    ...
    <main>
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-[0.92fr_0.88fr] md:items-center md:py-20">
        <div className="max-w-[900px]">
          ...
          <h1 className="mt-4 max-w-4xl text-5xl font-black tracking-tight text-[#2b2119] md:text-7xl">Tools in FourFeetz Production</h1>
            ...
            <div className="grid gap-8 md:grid-cols-[1.15fr_0.85fr] md:items-end">
              <div>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <p className="rounded-full border border-[#cdb397] bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.16em] text-[#6f4e37]">Documented Production Use</p>
              ...
              <div className="rounded-3xl border border-[#eadfce] bg-white p-6">
                <p className="text-sm font-black text-[#2b2119]">FourFeetz production use</p>
                ...
                <Link href={featuredTool.evidence.href} className="mt-4 inline-flex text-sm font-black text-[#6f4e37] underline decoration-[#d8c3ad] underline-offset-4">Related: {featuredTool.evidence.label} →</Link>
            ...
            {standardTools.map((tool) => (
              <article key={tool.name} className="flex h-full flex-col rounded-[32px] border border-[#eadfce] bg-[#fffdf8] p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl hover:shadow-[#6f4e37]/10">
                ...
                <div className="mt-auto pt-7">
                  <Link href={tool.evidence.href} className="mb-5 inline-flex text-sm font-black leading-6 text-[#6f4e37] underline decoration-[#d8c3ad] underline-offset-4">Related: {tool.evidence.label} →</Link>
