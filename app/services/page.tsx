      ...
      <section className="px-6 py-20 md:py-24">
        <div className="mx-auto flex max-w-7xl flex-col gap-7 rounded-[40px] bg-[#6f4e37] p-8 text-white shadow-xl shadow-[#6f4e37]/20 md:flex-row md:items-center md:justify-between md:p-12">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/videos" className="inline-flex rounded-full border border-white/45 px-7 py-4 font-black text-white transition hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white">
              View Videos
            </Link>
          </div>
        </div>
