...
export const metadata: Metadata = {
  ...
  description: "FourFeetz의 개인정보 수집, 이용, Google Analytics, Google AdSense, 쿠키 및 광고 정책을 안내합니다.",
...
export default function KoreanPrivacyPage() {
  return <StaticInfoPage eyebrow="정책" title="개인정보 처리방침" description="이 정책은 FourFeetz Studios 웹사이트를 방문하거나 스튜디오에 문의할 때 정보가 어떻게 처리되는지 설명합니다." updated="2026년 7월 15일" sections={[
    ...
    { title: "Google 광고", paragraphs: ["FourFeetz는 Google AdSense가 제공하는 광고를 표시할 수 있습니다.", "Google 및 그 파트너는 이 사이트 또는 다른 웹사이트의 이전 방문을 바탕으로 맞춤형 또는 비맞춤형 광고를 제공하기 위해 쿠키를 사용할 수 있습니다.", <>방문자는 Google 광고 설정(<a href="https://adssettings.google.com/" className="font-bold text-[#6f4e37] underline underline-offset-4">https://adssettings.google.com/</a>)에서 맞춤형 광고를 거부할 수 있습니다.</>, "방문자는 Google의 광고 및 개인정보처리방침을 통해 Google의 정보 이용 방식을 더 자세히 확인할 수 있습니다."] },
