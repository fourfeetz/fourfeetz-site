...
export default function KoreanPrivacyPage() {
  return <StaticInfoPage eyebrow="정책" title="개인정보 처리방침" description="이 정책은 FourFeetz Studios 웹사이트를 방문하거나 스튜디오에 문의할 때 정보가 어떻게 처리되는지 설명합니다." updated="2026년 8월 31일" updatedLabel="최종 수정일" mainClassName={koreanPageTypographyClass} sections={[
