...
export default function PageHero({ eyebrow, title, desc, illustration }: PageHeroProps) {
  const content = (
    <div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      {illustration ? (
        <div className="grid gap-10 md:grid-cols-[0.92fr_0.88fr] md:items-center">
          {content}
          <HeroIllustrationCard src={illustration.src} alt={illustration.alt} priority />
        </div>
      ) : (
        content
      )}
