      ...
      <section className="px-6 py-20">
        ...
        <div className="mx-auto mt-10 grid max-w-6xl gap-7">
          {[
            ...
            <article key={item.title} className={`${cardClass} grid overflow-hidden md:grid-cols-[minmax(240px,300px)_1fr] md:items-stretch`}>
              <div className="relative mx-auto aspect-[3/4] w-full max-w-[300px] overflow-hidden bg-[#e9ddcf] md:mx-0">
                <Image src={item.image} alt="" fill sizes="300px" className="scale-110 object-cover opacity-35 blur-xl" aria-hidden="true" />
                <div className="absolute inset-3 overflow-hidden rounded-[20px] bg-[#f8f1e8]/85 shadow-inner"><Image src={item.image} alt={item.alt} fill sizes="280px" className="object-contain" /></div>
              </div>
