...
export const searchFocusedInsights: Record<SearchFocusedInsightSlug, Record<Language, LocalizedInsight>> = {
  ...
  "pet-grooming-salon-promo-video-guide": {
    en: {
      ...
      related: [{ label: "Service", title: "Pet Grooming & Hotel Video", href: "/services/grooming-hotel" }, { label: "Production Notes", title: "What We Learned Making a Pet Hotel Promo", href: "/insights/pet-hotel-promo-video-production-notes" }],
    },
    ko: {
