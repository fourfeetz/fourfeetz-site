...
export const films: Film[] = [
  {
    slug: "moonlit-lake-puppy-kitten",
    title: "Moonlit Lake — Puppy & Kitten by the Fire",
    koreanTitle: "달빛 호수 — 모닥불 곁의 강아지와 고양이",
    category: "FourFeetz Relax Moments",
    duration: "6 min 26 sec",
    description: "A quiet FourFeetz Relax Moments film set beside a moonlit lake, with a puppy on a cushion, a kitten nearby, a warm fire, and two Moonlit Lake music tracks.",
    video: "/videos/films/moonlit-lake-puppy-kitten/moonlit-lake-puppy-kitten.mp4",
    thumbnail: "/images/works/moonlit-lake-puppy-kitten/cover.png",
    heroImage: "/images/works/moonlit-lake-puppy-kitten/cover.png",
    character: "Puppy & Kitten",
    tools: [],
    productionNotes: [
      { label: "Series", value: "FourFeetz Relax Moments · Episode 5" },
      { label: "Format", value: "1920 × 1080 · H.264 video with AAC audio" },
      { label: "Runtime", value: "6 minutes 25.568 seconds" },
      { label: "Music", value: "Moonlit Lake — Part 1 and Part 2 are both used in the finished film and available separately in the music library." },
      { label: "Artwork", value: "The supplied moonlit lake image is used as the film poster and music cover." },
    ],
    gallery: [{ title: "Moonlit Lake Cover Artwork", image: "/images/works/moonlit-lake-puppy-kitten/cover.png" }],
    release: "September 2026",
    status: "Released",
    language: "Music & Ambience",
    resolution: "Full HD",
    badges: ["NEW", "RELAX MOMENTS EP.05"],
    watchDescription: "Watch the complete six-minute Moonlit Lake film with both original music tracks. Playback starts only when you press play.",
    musicSlugs: ["moonlit-lake-part-1", "moonlit-lake-part-2"],
